	...
	case WM_CREATE:
		{
			...
			BUTTON_OPENSTORE	= CreateWindow(L"BUTTON", L"打开主题商店", WS_CHILD | WS_VISIBLE | SS_CENTER, 6, 80, 130, 35, hWnd, (HMENU)ID_BUTTON_OPENSTORE, ((LPCREATESTRUCT)lParam)->hInstance, NULL);
